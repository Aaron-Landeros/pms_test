...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForToday: "There are no releases scheduled for today.",
                        noEventForThisDay: "There are no releases scheduled for this day.",
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup = '<a href="https://entheospace.io/pms/pm/index.php?user_request='+event_data.user_request+'&project_id='+event_data.project_id+'&event_id='+event_data.id+'" target="_blank"> <div class="event-container calendar-task-item" role="button" data-project-id="'+event_data.project_id+'" data-event-index="'+(event_data.id)+'">';
    ...
    EvoCalendar.prototype.addEventIndicator = function(event) {
        ...
        function appendDot(date) {
            ...
            // Verificar si existe el contenedor de indicadores de eventos
            if (thisDate.find('span.event-indicator').length === 0) {
                thisDate.append('<span class="event-indicator"></span>');
            }
            
            // Verificar si ya se alcanzó el límite de 4 indicadores
            if (thisDate.find('span.event-indicator > .type-bullet').length >= 1) {
                //Máximo de 1 indicadores alcanzado
                return; // Detener la ejecución si ya hay 1 indicador
            }
        
            // Verificar si ya existe un indicador del tipo específico
            if (thisDate.find('span.event-indicator > .type-bullet > .type-'+event.type).length === 0) {
                let htmlToAppend = '<div class="type-bullet"><div ';
