...
<div class="modal fade modal-backdrop-custom" id="upload_project_file_modal">
    <div class="modal-dialog modal-lg modal-dialog-centered ">
        <div class="modal-content">
            <!-- Header -->
            <div class="modal-header bg-dark text-white d-flex justify-content-center position-relative">
                <h5 class="modal-title m-0"><i class="fa-solid fa-upload"></i> New <?= $folder_txt_display ?> File</h5>
                <button type="button" class="btn-close btn-close-white position-absolute end-0 me-3" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container">
                    <form action="" id="add_project_file_form" class="needs-validation" novalidate>
                        <input type="hidden" name="file_category" id="hidden_folder" value="<?= $folder ?>">
                        <div class="container d-flex flex-column justify-content-center mb-4 mt-3 w-75">
                            <div class="mb-4">
                                <b class=""><i class="fa-regular fa-message"></i> &nbsp;Comments: </b>
                                <div class="mt-2">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="textarea_file_comments" name="file_comment" required></textarea>
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            ...
                            <button class="btn btn-outline-success fw-bold" 
                                    id="btn_upload_project_file"
                                    type="submit"
                                    form="add_project_file_form">
                                    Save
                            </button>

                            <div class="spinner-border text-primary d-none" id="loader_for_btn_upload_project_file" role="status">
