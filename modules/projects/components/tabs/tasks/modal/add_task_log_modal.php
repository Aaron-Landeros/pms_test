...
<div class="modal fade modal-backdrop-custom" id="add_task_log_modal">
    <div class="modal-dialog modal-lg modal-dialog-centered ">
        <div class="modal-content" >
            <!-- Header -->
            <div class="modal-header bg-dark text-white d-flex justify-content-center position-relative">
                <h5 class="modal-title m-0"><i class="fa-solid fa-list-check"></i> New Task Log</h5>
                <button type="button" class="btn-close btn-close-white position-absolute end-0 me-3" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container">
                    <form action="" id="form_add_task_log" class="needs-validation" novalidate>
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            ...
                            <button class="btn btn-outline-success fw-bold" 
                                    id="btn_add_task_log"
                                    type="submit"
                                    form="form_add_task_log">
                                    Save
                            </button>

                            <div class="spinner-border text-primary d-none" id="loader_for_btn_add_task_log" role="status">
